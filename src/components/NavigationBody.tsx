...
const NavigationBody = ({ title, hasBackButton = true, position = NavigationHeaderPosition.Left, onPressBackButton, headerLeft, headerRight, style, }: IProps) => {
    return (
...
export default memo(NavigationBody);;
